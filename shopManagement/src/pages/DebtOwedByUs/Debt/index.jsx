  ...
  const cashVoda = [
    {
      ...
      name: " محمد احمد ",
      value: '100000',
      notes: 'عليه سحب ب 2500 رقم تليفونه 01011497266',
    },
    {
      _id: 2,
      name: "احمد الخولى  ",
      value: '100000',
      notes: 'عليه 5000 فودافون كاش وشيل العموله منهم ',
    },
    {
      _id: 3,
      name: "احمد العربي  ",
    ...
    <div className="dashboard d-flex flex-row">
      ...
      <div className="container text-center">
        <div className="shadow-none p-3 mt-3 mb-5 bg-body rounded main-title">
          <h2 className='fs-1 fw-bold text-dark'>مديونية لمكتب الفتح</h2>
        </div>
        <div className="d-flex flex-row justify-content-between">
          <Link to="/dash/elfath/our-debt/add-new-debt">
          ...
          <tbody>
            {!loading && cashVoda?.map((item, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link
                    to={`/dash/elfath/our-debt/update-debt/${item._id}`}
                    state={{ item: item }}
                  >
