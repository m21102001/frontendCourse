    ...
    <div className="dashboard d-flex flex-row">
      <div className="container text-center">
        <div className="shadow-none p-3 mt-3 mb-5 bg-body rounded main-title">
          <h2 className='fs-1 fw-bold text-dark'>اضافة داين جديد</h2>
        </div>
        <form
        ...
        >
          ...
          <button onClick={() => navigate(`/dash/elfath/debt-owed-by-us`)} className="d-grid col-3 py-3 fs-4 fw-bold align-content-center mx-auto btn btn-danger mb-4">
            cancel
          </button>
        </form>
      </div>
...
export default AddNewDebtOwedByUs